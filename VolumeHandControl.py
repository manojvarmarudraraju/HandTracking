...
detector = htm.handDetector(False, 1, detectionCon=0.7)
...
while True:
    ...
    if len(lmList) != 0:
        ...
        vol = np.interp(length, [12, 250], [minVol, maxVol])
        volBar = np.interp(length, [12, 250], [400, 150])
        volPer = np.interp(length, [12, 250], [0, 100])
